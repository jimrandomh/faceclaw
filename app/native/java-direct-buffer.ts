 ...
 *
 * Why this exists: NativeScript Android (9.0.4, and main as of 2026-09-16)
 ...
 * not keep a reference. SurfaceCompositor.applyAndComposite copies the pixels
 * and parses the draw list before returning, which satisfies this. One
 * instance belongs to one JS context (main thread or one worker); instances
