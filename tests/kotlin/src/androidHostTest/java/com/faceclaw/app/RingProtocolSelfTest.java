 ...
 * field layout.
 *
 * <p>Run through JavaCompatibilityTest ({@code npm run test:kotlin}), which
 * also checks that the Kotlin port keeps the Java-facing API the TypeScript
 * health ingest reads.
 *
...
public final class RingProtocolSelfTest {
    ...
    public static void main(String[] args) {
        ...
        if (failures != 0) {
            throw new AssertionError(failures + " of " + checks + " ring protocol checks failed");
        }
    }
